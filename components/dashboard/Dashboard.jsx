...
//     //   }
//     const dummyUser = { name: 'Yashika', role: 'student' }
// const dummyBookings = [
//   { id: 1, meal: 'Lunch', status: 'booked' },
//   { id: 2, meal: 'Dinner', status: 'booked' },
// ]
...
export default function Dashboard() {
  ...
  /* ==============================
     Fetch Data (Dummy Frontend Only)
     ============================== */
  const fetchData = useCallback(async () => {
    if (!token) {
      setLoading(false)
    ...
    try {
      ...
      const dummyUser = { name: 'Yashika', role: 'student' }
      const dummyBookings = [
        { id: 1, type: 'lunch', meal: 'Lunch Meal', calories: 650, status: 'booked', booked: true },
        { id: 2, type: 'dinner', meal: 'Dinner Meal', calories: 700, status: 'booked', booked: true },
      ]
  ...
  /* ==============================
     Dummy Meal Actions
     ============================== */
  const handleCancelMeal = (mealId, mealType) => {
    if (!token) return toast.error('Please log in again.')
